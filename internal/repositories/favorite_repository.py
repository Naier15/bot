...
class FavoriteRepository:
    ...
    async def get_favorites_by_user(self, user: User) -> list[dict]:
        ...
        for fav_flat in flats:
            ...
            # print(
            #     f'{ fav_flat.id }-{ flat.id }-- '
            #     f'{ flat.fk_building.fk_property.name } №{ flat.fl_num } has last '
            #     f'price={ fav_flat.price } and new price={ flat.price_history.first().current_price }'
            # )
